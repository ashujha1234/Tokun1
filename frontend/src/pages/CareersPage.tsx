...
import { BriefcaseBusiness, Users, Rocket, HeartHandshake, ArrowRight } from "lucide-react";
...
<section className="container mx-auto px-4 sm:px-6 pt-32 sm:pt-36 lg:pt-40 pb-16 text-center">
          ...
          >
            ...
            <p className="mt-6 text-white/75 text-base sm:text-lg leading-relaxed max-w-3xl mx-auto">
              We are building a product for the next generation of AI users. If you care about
              product quality, meaningful speed, and creating tools people truly love to use,
              TOKUN could be the place for you.
            </p>
            ...
            <div className="mt-8 flex justify-center">
              <Button
                ...
                onClick={() => {
                  window.location.href = "mailto:careers@tokun.ai?subject=Career%20Application";
                }}
              >
                Apply Now
            ...
            >
              <div className="rounded-[31px] bg-[#08090B] p-6 sm:p-8">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold">Why join TOKUN</h2>
                </div>

                <ul className="space-y-4 text-white/78 text-sm leading-relaxed">
                  <li>Work on a focused AI product with real user impact.</li>
                  <li>Collaborate with a small, ambitious, product-first team.</li>
                  <li>Contribute to features that shape prompt creation and monetization.</li>
                  <li>Grow in an environment that values initiative and strong execution.</li>
                  <li>Help define how modern users interact with LLM workflows.</li>
                </ul>
              </div>
            </div>
            ...
            <div>
              <div className="mb-8">
                ...
                <p className="mt-3 text-white/70 max-w-2xl">
                  We are looking for thoughtful people who want to build meaningful tools with speed and care.
                </p>
              </div>
