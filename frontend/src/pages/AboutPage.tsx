...
export default function AboutPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#030406] text-white overflow-x-hidden">
      ...
      <main className="relative z-10">
        <section className="container mx-auto px-4 sm:px-6 pt-20 sm:pt-24 lg:pt-28 pb-16 text-center">
          <motion.div
            initial={{ opacity: 0, y: 18 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.45 }}
            ...
            >
              <div className="rounded-[31px] bg-[#08090B] p-6 sm:p-8">
                ...
                <ul className="space-y-4 text-white/80">
                  ...
                  <li>
                    Help individuals and teams save time while improving AI
                    output quality.
                  </li>
                  <li>
              ...
              return (
                ...
                >
                  <div className="rounded-[29px] bg-[#08090B] p-6 h-full transition-colors duration-300 group-hover:bg-[#0B0D11]">
                    ...
                    <p className="text-white/72 leading-relaxed text-sm">
                      {item.description}
                    </p>
                  </div>
                </motion.div>
