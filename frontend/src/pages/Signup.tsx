...
// //             <a href="mailto:support@tokun.world" className="text-transparent bg-clip-text bg-gradient-to-r from-[#7D4DFF] via-[#A24BFF] to-[#FF2CC3] underline underline-offset-4">
// //               support@tokun.world
// //             </a>
// //           </p>
// //         </div>
