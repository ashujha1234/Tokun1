...
import { Landmark, X, Check, ChevronDown } from "lucide-react";
                      ...
                      accounts.map((account) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {/* The slide-in stays on a wrapper instead of
                                moving onto the bin: both animate `transform` —
                                this one to slide in from the right, the bin to
                                scale down on press — and an element can only
                                carry one.

                                No confirm dialog here, unlike the payout-account
                                bins in Header/AccountMenu. Manage mode is this
                                screen's deliberate step: the bin doesn't exist
                                until it's switched on, so the click can't be a
                                stray one. */}
                            <div
                              className="absolute"
                              style={{
