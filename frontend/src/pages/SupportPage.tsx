...
// import { Mail, MessageCircleHeart, Clock3, ShieldCheck, HelpCircle, ArrowRight } from "lucide-react";
...
//               Whether you have a billing issue, a product question, or need help getting started,
//               our support team is ready to assist you with clear and practical guidance.
//             </p>
//           </motion.div>
//         </section>
...
//                     <p className="text-white/72 text-sm leading-relaxed">{item.description}</p>
//                   </div>
//                 </motion.div>
//               );
//             })}
...
//                 <h2 className="text-2xl sm:text-3xl font-bold mb-6">Contact support</h2>
...
//                       <div className="text-white/70 text-sm mt-1">support@tokun.ai</div>
//                       <p className="text-white/65 text-sm mt-2">
//                         Best for billing help, platform support, account access issues, and general questions.
//                       </p>
//                     </div>
//                   </div>
...
//                       <p className="text-white/65 text-sm mt-2">
//                         We usually respond within 24 hours on business days. Urgent account issues are prioritized.
//                       </p>
//                     </div>
//                   </div>
//                 </div>
...
//                     To help us resolve your issue faster, include screenshots, error messages,
//                     and the steps you followed before the issue appeared.
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//               Quick answers to common questions about support, account help, and product usage.
//             </p>
//           </div>
...
//                   <p className="text-white/72 text-sm leading-relaxed">{item.a}</p>
//                 </div>
//               </div>
//             ))}
//           </div>
...
export default function SupportPage() {
  return (
    <div className="relative min-h-screen bg-[#030406] text-white overflow-x-hidden">
      ...
      <main className="relative z-10">
       <section className="container mx-auto px-4 sm:px-6 pt-32 sm:pt-36 lg:pt-40 pb-16">
          <motion.div
            initial={{ opacity: 0, y: 18 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.45 }}
