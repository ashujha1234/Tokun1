...
// const original = Number(originalTokens);
// const optimized = Number(optimizedTokens);
// const savedTokens = Math.max(0, original - optimized);

// const updatedUser = await User.findByIdAndUpdate(
//   req.user._id,
//   { $inc: { lifetimeTokunSaved: savedTokens } },
//   { new: true }
// ).select("_id name email lifetimeTokunSaved plan userType role");

// res.json({
//   success: true,
//   optimizedPrompt,
//   user: updatedUser || resuser.user,
//   savedTokens,
// });
//   } catch (err) {
